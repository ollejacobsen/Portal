...
export default function UnsubscribePage() {
    ...
    const HeaderNotification = () => {
        if (pageData.comments && commentsEnabled) {
            ...
            return (
                <>
                    <p className={`gh-portal-text-center gh-portal-header-message ${hideClassName}`}><strong>{member?.email}</strong> kommer inte längre att få e-postmeddelanden när någon svarar på dina kommentarer.</p>
                </>
            );
        }
        ...
        <NewsletterManagement
            ...
            unsubscribeAll={async () => {
                ...
                onAction('showPopupNotification', {
                    ...
                    message: `E-postinställning uppdaterad.`
                });
