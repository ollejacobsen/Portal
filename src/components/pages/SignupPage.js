...
class SignupPage extends React.Component {
    ...
    renderFreeTrialMessage() {
        ...
        if (hasFreeTrialTier({site})) {
            return (
                <p className='gh-portal-free-trial-notification'>När en gratis provperiod slutar debiteras du ordinarie pris för den nivå du har valt. Du kan alltid avboka innan dess.</p>
            );
        }
        return null;
    }
